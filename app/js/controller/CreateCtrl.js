//wp_gote_advanced_plugin_app.app.controller( 'CreateCtrl', [
//    '$scope', '$state', '$timeout', 'PostsSrvc', 'CategoriesToJsonSrvc', 'TagsToJsonSrvc', 'CategoriesSrvc', 'TagsSrvc', '$filter',
//     function( $scope, $state, $timeout, PostsSrvc, CategoriesToJsonSrvc, TagsToJsonSrvc, CategoriesSrvc, TagsSrvc, $filter ){
//            
//         $scope.newPost = [
//             {
//                "status": '',
